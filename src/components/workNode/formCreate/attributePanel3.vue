...
<template>
  <Row class="atr">
    ...
    <Col class="atr-action">
      ...
      <Row>
        <Col class="atr-act-con l t" :span="10">货币符号</Col>
        <Col class="atr-act-con" :span="14">
          <Select class="select" v-model="curr">
            <Option v-for="item in currData" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </Select>
        </Col>
      </Row>
      ...
      <Row>
        <Col class="atr-act-con c" :span="24">
          <Checkbox v-model="single">限定数值范围</Checkbox>
        </Col>
      </Row>
      <Row>
        <Col class="atr-act-con c" :span="24">
          <Checkbox v-model="single">允许小数</Checkbox>
        </Col>
      </Row>
      <Row>
        <Col class="atr-act-con c" :span="24">
          <Checkbox v-model="single">保留N位小数</Checkbox>
        </Col>
      </Row>
      <!--<Row>-->
        <!--<Col class="atr-act-con c" :span="24">-->
